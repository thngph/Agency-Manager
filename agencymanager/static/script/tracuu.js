...
async function handleClick() {
  ...
  let newdata4 = [];
  // Loc ma dai ly
  if (parseInt(inputDaiLy.value) != 0) {
  ...
  else if(inputTienNoMin.value == "" && inputTienNoMax.value != "")
  {
    newdata4 = newdata3.filter(function (item) {
      return (
        parseInt(item.SoTienNo) <= parseInt(inputTienNoMax.value)
  ...
  newdata4.map((item) => {
    const template = `
      ...
      <!-- Tiền nợ -->
      <td class="tg-gvcd">
      <svg style="width: 30px;  margin-right:10px; display:unset; cursor: pointer;" class="edit-icon" data-id=${item.MaDaiLy}
      ...
      <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
       ...
       <svg style="width: 30px; display:unset; cursor: pointer;" class="remove-icon" data-id=${item.MaDaiLy} xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
